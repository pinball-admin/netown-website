...
const predictions: Record<string, Record<string, { winner: string; score: string; confidence: number; analysis: string; recentForm: string; keyInsight: string }>> = {
  'beckham_chen': {
    ...
    '4': { winner: 'Morocco', score: '2-1', confidence: 63, analysis: 'Morocco dark horse 2022 memories fuel belief. Hakimi vs Nigeria\'s left defensive frailties. Amrabat withdrawn role disrupts Nigeria 4-3-3 pressing trigger. En-Nesyri poacher instinct prevails in tight affair.', recentForm: '🏆🏆🏆🏆🔥', keyInsight: 'Set-piece excellence: Morocco converts 3/4 corner situations vs Africa opponents' },
    ...
    '12': { winner: 'Japan', score: '2-0', confidence: 57, analysis: 'Japan tactical evolution under Moriyasu unprecedented preparation (7 training camps). Bundesliga factory pipeline: 8 Japan starters vs Germany leagues. Australia structural rigidity 4-4-2 predictability vs Japan 4-3-3 fluid interchange.', recentForm: '🔥🏆🏆🏆🔥', keyInsight: 'Real Sociedad's Kubo + Leipzig's Olmo = Spain-lite replication, defeating Australia systematically' },
  },
  'zidane_gao': {
...
const FOOTBALL_IMAGES = {
  pitch: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=400',
  action: 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=400',
  goal: 'https://images.unsplash.com/photo-1518063319789-7217e6706b04?w=400',
  fans: 'https://images.unsplash.com/photo-1522778114943-52418b61a052?w=400',
}

const communityPosts: CommunityPost[] = [
  { id: 1, author: 'MessiFanArgentina', avatar: '🔵', country: '🇦🇷', content: 'USA vs Morocco opening match analysis: Pulisic is the key. His Chelsea form resurrection this season has been incredible. If he stays fit, USA goes through from Group A. The home advantage cannot be underestimated!', imageUrl: 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=400', likes: 234, comments: 45, time: '2h ago', isHot: true, isPinned: true, tags: ['USA', 'Morocco', 'Analysis'] },
  { id: 2, author: 'CroatiaWizard', avatar: '🔴', country: '🇭🇷', content: 'Modric at 41 still running the show! His partnership with Kovacic and Brozovic is the heartbeat of this team. Nigeria better watch out - Croatia midfield control is UNREAL.', imageUrl: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=400', likes: 189, comments: 32, time: '3h ago', isHot: true, tags: ['Croatia', 'Modric', 'Midfield'] },
  { id: 3, author: 'BrazilianSambaKing', avatar: '💛', country: '🇧🇷', content: 'Neymar ALONE is worth the ticket price! His final World Cup - the entire Brazil is behind him. 2026 is HIS tournament. Prediction: 8 goals minimum!', imageUrl: 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=400', likes: 567, comments: 89, time: '4h ago', isHot: true, tags: ['Brazil', 'Neymar', 'Prediction'] },
  { id: 4, author: 'EnglandHoper2026', avatar: '⚽', country: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', content: 'Southgate OUT! Kane needs proper service. 2022 penalty heartbreak cannot happen again. Our golden generation deserves a trophy! Trusting Shearer Zhang prediction: England reaches quarters minimum.', imageUrl: 'https://images.unsplash.com/photo-1518063319789-7217e6706b04?w=400', likes: 345, comments: 67, time: '5h ago', isHot: true, tags: ['England', 'Kane', 'Analysis'] },
  { id: 5, author: 'FranceUltraMbappe', avatar: '💙', country: '🇫🇷', content: 'Mbappe 2026 = Ronaldo 2002 zone! Euro 2024 humiliation → World Cup glory transformation. France dark horse? NO! France is the FAVORITE. Hat-tricks incoming!', imageUrl: 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=400', likes: 456, comments: 78, time: '6h ago', isHot: true, tags: ['France', 'Mbappe', 'Favorites'] },
  { id: 6, author: 'GermanyTechExpert', avatar: '⚫', country: '🇩🇪', content: 'Nagelsmann tactical revolution fascinating! Wirtz false-9 hybrid, Musiala gravity creation, Havertz movement... Germany WC2022 trauma fuel → 2026 CHAMPIONS!', imageUrl: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=400', likes: 298, comments: 41, time: '7h ago', tags: ['Germany', 'Nagelsmann', 'Tactics'] },
  { id: 7, author: 'MexicoLuchaLibre', avatar: '💚', country: '🇲🇽', content: 'Chicharito comeback narrative EPIC! Mexico tournament resilience tradition: 7/8 quarter appearances. Dallas humidity advantage vs Poland. WE GOING THROUGH!', imageUrl: 'https://images.unsplash.com/photo-1522778114943-52418b61a052?w=400', likes: 234, comments: 56, time: '8h ago', tags: ['Mexico', 'Chicharito', 'Analysis'] },
  { id: 8, author: 'JapanBundesligaFan', avatar: '🔴', country: '🇯🇵', content: 'Kubo + Oiyma La Masia synthesis UNSTOPPABLE! 8 Japan players in Bundesliga = tactical preparation sophistication. Australia cannot handle Japan 4-3-3 fluid interchange!', imageUrl: 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=400', likes: 187, comments: 29, time: '9h ago', tags: ['Japan', 'Kubo', 'Bundesliga'] },
  { id: 9, author: 'SpainTikiTakaLegacy', avatar: '🔴', country: '🇪🇸', content: 'Lamine Yamal + Pedri = Xavi Iniesta 2.0! Spain rebuild complete. Euro 2024 near-miss → 2026 revenge. Rodri Ballon d\'Or contender!', imageUrl: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=400', likes: 345, comments: 52, time: '10h ago', tags: ['Spain', 'Youth', 'Rebuild'] },
  { id: 10, author: 'PortugalRonaldoFan', avatar: '🔴', country: '🇵🇹', content: 'Ronaldo final dance PART 2! B Silva and Felix must step up. Bernardo Silva Manchester City form = KEY. Euro 2016 template replication!', imageUrl: 'https://images.unsplash.com/photo-1518063319789-7217e6706b04?w=400', likes: 289, comments: 43, time: '11h ago', tags: ['Portugal', 'Ronaldo', 'B-Silva'] },
  { id: 11, author: 'NetherlandsOranje', avatar: '🟠', country: '🇳🇱', content: 'Van Dijk defensive leadership + Memphis Depay attack = Netherlands balance! Wijnaldum return provides experience. Semi-finals or better prediction!', imageUrl: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=400', likes: 178, comments: 34, time: '12h ago', tags: ['Netherlands', 'Van-Dijk', 'Analysis'] },
  { id: 12, author: 'BelgiumGoldenGen', avatar: '🔴', country: '🇧🇪', content: 'De Bruyne + Lukaku partnership KEY! Belgium 2018 disappointment → 2026 redemption. Kevin Guardian mode activated. Quarter-finals minimum!', imageUrl: 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=400', likes: 234, comments: 41, time: '13h ago', tags: ['Belgium', 'De-Bruyne', 'Redemption'] },
  { id: 13, author: 'ItalyDefensiveArt', avatar: '🔵', country: '🇮🇹', content: 'Donnarumma + Bastoni + Bucciarelli = Italy defensive dynasty! Spalletti tactical innovation. Euro 2020 champions momentum carries to 2026!', imageUrl: 'https://images.unsplash.com/photo-1518063319789-7217e6706b04?w=400', likes: 198, comments: 28, time: '14h ago', tags: ['Italy', 'Defense', 'Spalletti'] },
  { id: 14, author: 'UruguayTraditionalist', avatar: '⚽', country: '🇺🇾', content: 'Nunez + Valverde + Bentancur = Uruguay physical dominance! Darwin Darwin Darwin - his pressing will terrify opponents. Dark horse CHAMPION pick!', imageUrl: 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=400', likes: 267, comments: 48, time: '15h ago', tags: ['Uruguay', 'Nunez', 'Dark-Horse'] },
  { id: 15, author: 'MoroccoAtlasLion', avatar: '🟢', country: '🇲🇦', content: 'Hakimi Inter teammates revenge motivation! Amrabat return = defensive excellence. 2022 semi-final inspiration carries forward. AFRICA RISING!', imageUrl: 'https://images.unsplash.com/photo-1522778114943-52418b61a052?w=400', likes: 312, comments: 55, time: '16h ago', isHot: true, tags: ['Morocco', 'Hakimi', 'Africa'] },
  { id: 16, author: 'SenegalLions', avatar: '💛', country: '🇸🇳', content: 'Mané + Koulibaly = Senegal trophy dream! Mane Bayern form resurrection = tournament Pulisic equivalent. Africa champion PREDICTION!', imageUrl: 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=400', likes: 189, comments: 32, time: '17h ago', tags: ['Senegal', 'Mane', 'Africa'] },
  { id: 17, author: 'PolandLegacy', avatar: '⚪', country: '🇵🇱', content: 'Lewandowski final chance REDEMPTION! 2022 penalty miss → 2026 glory arc. Zielinski Napoli form = creative support. Fighting!', imageUrl: 'https://images.unsplash.com/photo-1518063319789-7217e6706b04?w=400', likes: 234, comments: 41, time: '18h ago', tags: ['Poland', 'Lewandowski', 'Redemption'] },
  { id: 18, author: 'CameroonIndomitable', avatar: '🟢', country: '🇨🇲', content: 'Song Ekango + Andre Onana = Cameroon unity! Napoli Song form = tournament surprise package. Africa dark horse!', imageUrl: 'https://images.unsplash.com/photo-1522778114943-52418b61a052?w=400', likes: 145, comments: 23, time: '19h ago', tags: ['Cameroon', 'Onana', 'Africa'] },
  { id: 19, author: 'ColombiaCoffee', avatar: '💛', country: '🇨🇴', content: 'James Rodriguez LIVERPOOL REVIVAL! Colombia qualification momentum = World Cup confidence. South America dark horse!', imageUrl: 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=400', likes: 167, comments: 28, time: '20h ago', tags: ['Colombia', 'James', 'South-America'] },
  { id: 20, author: 'AustraliaSocceroos', avatar: '🟡', country: '🇦🇺', content: 'Mathew Leckie experience + A-League quality improvement = Australia competitive! Group C challenge = motivational opportunity!', imageUrl: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=400', likes: 123, comments: 19, time: '21h ago', tags: ['Australia', 'Leckie', 'Competitive'] },
  { id: 21, author: 'CanadaMapleLeaf', avatar: '🔴', country: '🇨🇦', content: 'Davies Bayern speed + Portland Davies form = Canada attacking threat! First World Cup = historical momentum. GO CANADA GO!', imageUrl: 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=400', likes: 198, comments: 35, time: '22h ago', isHot: true, tags: ['Canada', 'Davies', 'Historic'] },
  { id: 22, author: 'SaudiArabiaEagles', avatar: '💚', country: '🇸🇦', content: 'Al-Dawsari creativity + naturalized players quality = Saudi improvement! 2022 upset vs Argentina = template. Asian pride!', imageUrl: 'https://images.unsplash.com/photo-1522778114943-52418b61a052?w=400', likes: 156, comments: 24, time: '23h ago', tags: ['Saudi', 'Al-Dawsari', 'Asia'] },
  { id: 23, author: 'SouthKoreaTaeguk', avatar: '🔵', country: '🇰🇷', content: 'Son Heung-min Golden Boot legacy + Hwang Hee-chan partnership = Korea attacking threat! Celtic connection preparation. Asian excellence!', imageUrl: 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=400', likes: 234, comments: 38, time: '1d ago', tags: ['Korea', 'Son', 'Asian'] },
  { id: 24, author: 'Qatar2022Lessons', avatar: '🔴', country: '🇶🇦', content: 'Host nation pressure ANALYSIS! Qatar 2022 learning = 2026 improved hosting. First tournament appearance growing pains OVER!', imageUrl: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=400', likes: 98, comments: 15, time: '1d ago', tags: ['Qatar', 'Host', 'Analysis'] },
  { id: 25, author: 'PredictorPro', avatar: '⚽', country: '🌍', content: 'AI Expert Analysis Summary: Argentina 18% crown defense, France +12% from Euro trauma, Brazil Neymar redemption, Germany Nagelsmann revolution. TOURNAMENT WILL BE EPIC!', imageUrl: 'https://images.unsplash.com/photo-1518063319789-7217e6706b04?w=400', likes: 456, comments: 72, time: '1d ago', isHot: true, isPinned: true, tags: ['AI', 'Prediction', 'Summary'] },
  { id: 26, author: 'EnglandDefensive', avatar: '⚽', country: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', content: 'Southgate tactical dilemma: 3-4-3 vs 4-3-3 vs 4-2-3-1. Walker Trent Alexander-Arnold fullback dilemma. Rice and Mainoo pivot chemistry TEST!', imageUrl: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=400', likes: 167, comments: 41, time: '1d ago', tags: ['England', 'Southgate', 'Tactics'] },
]
